@extends('admin.layouts.app') @section('content') <div class="container-fluid">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <center class="m-t-30"> <img id="user-image" class="rounded-circle"
                                                src="{{asset('assets/images/users/male_avatar.svg')}}" alt="your image"
                                                width="150" /> <input type='file' name="image" id="user-image-btn"
                                        ...
                                        <form class="form-horizontal form-material mx-2">
                                            ...
                                            <div class="form-group"> <label for="user_name" class="col-md-12">User
                                                ...
                                                <div class="col-md-12"> <input type="user_name" placeholder="john12"
                                                        ...
                                                        value="{{old('user_name')}}" id="user_name"> @error('user_name')
    ...
    function readURL(input) { if (input.files && input.files[0]) { var reader = new FileReader(); reader.onload = function (e) { $('#user-image') .attr('src', e.target.result); }; reader.readAsDataURL(input.files[0]); } } 
</script> @endpush