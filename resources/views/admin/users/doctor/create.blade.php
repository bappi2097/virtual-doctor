...
@section('breadcrumbs', Breadcrumbs::render('admin.doctor.create'))
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form action="{{ route('admin.users.doctor.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <a href="{{ route('admin.users.doctor.index') }}"
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal form-material mx-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="user_name" placeholder="john12"
