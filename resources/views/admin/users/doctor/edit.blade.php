...
@section('breadcrumbs', Breadcrumbs::render('admin.doctor.edit', $user->id))
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body"> <a href="{{ route('admin.users.doctor.index') }}"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal form-material mx-2"
                                            action="{{ route('admin.users.doctor.update', $user->id) }}" method="POST"
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal form-material mx-2"
                                            action="{{ route('admin.users.doctor.change-password', $user->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('PUT')
