...
@section('breadcrumbs', Breadcrumbs::render('patient.doctor.show', $user->id))
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('patient.users.doctor.index') }}" class="btn waves-effect waves-light btn-info">
                                            ...
                                            <div class="row text-center justify-content-md-center">
                                                <div class="col-4">
                                                    <a href="javascript:void(0)" class="link">
                                                        ...
                                                        <font class="font-medium">Doctor</font>
                                                    </a>
                                                </div>
                                                <div class="col-4">
                                                    <a href="javascript:void(0)" class="link">
