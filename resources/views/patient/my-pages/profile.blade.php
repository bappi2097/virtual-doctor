...
@section('breadcrumbs', Breadcrumbs::render('patient.profile'))
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-2" action="{{ route('patient.profile.update') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="email" placeholder="johnathan@patient.com" name="email" id="email"
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-2"
                            action="{{ route('patient.profile.change-password') }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
