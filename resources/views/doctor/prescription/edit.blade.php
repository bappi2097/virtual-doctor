...
@section('breadcrumbs', Breadcrumbs::render('doctor.prescription.edit', $prescription->id))
                                                    ...
                                                    <select name="doctor_id" id="doctor_id"
                                                        ...
                                                        @foreach (App\Models\User::role('doctor')->get() as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ selected($item->id, $prescription->doctor_id) }}>
                                                                {{ $item->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select name="patient_id" id="patient_id"
                                                        ...
                                                        @foreach (App\Models\User::role('patient')->get() as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ selected($item->id, $prescription->patient_id) }}>
                                                                {{ $item->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="appointment_id" id="appointment_id"
                                                        ...
                                                        @foreach (App\Models\Appointment::with('doctor', 'patient')->get() as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ selected($item->id, $prescription->appointment->id) }}>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <textarea name="description" id="description" cols="30" rows="10"
                                                            ...
                                                            required>{!! $prescription->description !!}</textarea>
                                                        @error('description')
