...
@section('breadcrumbs', Breadcrumbs::render('doctor.report.edit', $report->id))
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form-horizontal form-material mx-2">
                                            <form action="{{ route('doctor.reports.update', $report->id) }}" method="POST"
                                                ...
                                                <tbody>
                                                    @foreach ($report->documents as $item)
                                                        <tr class="d_row">
                                                            ...
                                                            <td class="">
                                                                <form
                                                                    action="{{ route('doctor.documents.delete', $item->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
                                            ...
                                            <form action="{{ route('doctor.documents.store', $report->id) }}"
