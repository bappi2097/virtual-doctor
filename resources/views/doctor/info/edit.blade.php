...
@section('breadcrumbs', Breadcrumbs::render('doctor.info.edit', $info->id))
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form action="{{ route('doctor.infos.update', $info->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <a href="{{ route('doctor.infos.index') }}" class="btn waves-effect waves-light btn-info">
                                                    ...
                                                    <select name="tag" id="tag" class="form-control form-control-line">
                                                        @foreach (Spatie\Tags\Tag::all() as $item)
                                                            <option value="{{ $item->name }}"
                                                                {{ selected($item->name, $info->tags[0]->name) }}>
                                                                {{ $item->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="title" id="title"
                                                            placeholder="Dhaka Ambulance" value="{{ $info->title }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="address" id="address"
                                                            placeholder="22B, Baker St." value="{{ $info->address }}"
                                                            class="form-control form-control-line" required />
                                                        @error('address')
                                                            <span class="text-danger">
                                                                <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="phone" id="phone"
                                                            placeholder="+8801XXXXXXXXX" value="{{ $info->phone }}"
                                                            class="form-control form-control-line" required />
                                                        @error('phone')
                                                            <span class="text-danger">
                                                                <strong>{{ $message }}</strong>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <textarea name="details" id="details" cols="30" rows="10"
                                                            ...
                                                            required>{{ $info->details }}</textarea>
                                                        @error('details')
                                                            <span class="text-danger">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
