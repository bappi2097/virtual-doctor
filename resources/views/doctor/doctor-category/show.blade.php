...
@section('breadcrumbs', Breadcrumbs::render('doctor.doctor-category.show', $doctorCategory->id))
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('doctor.doctor-category.index') }}"
                            class="btn waves-effect waves-light btn-info">
                            <i class="mdi mdi-arrow-left"></i> Back
                        </a>
                        <a href="{{ route('doctor.doctor-category.doctor.doctor-index', $doctorCategory->slug) }}"
