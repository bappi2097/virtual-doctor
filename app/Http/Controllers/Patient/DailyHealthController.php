...
class DailyHealthController extends Controller
{
    ...
    {
        return view('patient.health.index', [
            'healths' => DailyHealth::with('patient')->where('patient_id', auth()->user()->id)->latest()->get()
        ]);
    }
    ...
    {
        return view('patient.health.create');
    }
    ...
    public function show(DailyHealth $dailyHealth)
    {
        ...
        return view('patient.health.show', [
    ...
    {
        return view('patient.health.edit', [
            'dailyHealth' => $dailyHealth
        ]);
    }
